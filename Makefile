...
# Project:  add-nbo.pro
# Template: app
# Command: /home/hktomato/Qt/5.15.0/gcc_64/bin/qmake -o Makefile add-nbo.pro
#############################################################################
...
QMAKE         = /home/hktomato/Qt/5.15.0/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/hktomato/Qt/5.15.0/gcc_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/hktomato/Qt/5.15.0/gcc_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
...
DISTDIR = /home/hktomato/BoB_network/add-nbo/.tmp/add-nbo1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/home/hktomato/Qt/5.15.0/gcc_64/lib
LIBS          = $(SUBLIBS) /home/hktomato/Qt/5.15.0/gcc_64/lib/libQt5Core.so -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = ../../Qt/5.15.0/gcc_64/mkspecs/features/spec_pre.prf \
		...
		add-nbo.pro add-nbo.h main.cpp
...
Makefile: add-nbo.pro ../../Qt/5.15.0/gcc_64/mkspecs/linux-g++/qmake.conf ../../Qt/5.15.0/gcc_64/mkspecs/features/spec_pre.prf \
		../../Qt/5.15.0/gcc_64/mkspecs/common/unix.conf \
		../../Qt/5.15.0/gcc_64/mkspecs/common/linux.conf \
		../../Qt/5.15.0/gcc_64/mkspecs/common/sanitize.conf \
		../../Qt/5.15.0/gcc_64/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents add-nbo.h $(DISTDIR)/
...
moc_predefs.h: ../../Qt/5.15.0/gcc_64/mkspecs/features/data/dummy.cpp
	g++ -pipe -O2 -std=gnu++11 -Wall -Wextra -dM -E -o moc_predefs.h ../../Qt/5.15.0/gcc_64/mkspecs/features/data/dummy.cpp
